...
Quotient also brings you **Quotient Alpha**,a section of our platform where we focus on hacky, innovative research projects. Stay tuned for more releases in Quotient Alpha as we continue to push the boundaries of AI development! You can read about our latest project, a framework for aligning LLM-judges to human feedback, [here](https://www.quotientai.co/post/subject-matter-expert-language-liaison-smell-a-framework-for-aligning-llm-evaluators-to-human-feedback). 
