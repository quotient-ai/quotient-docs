---
title: 'PromptLab: Prompt engineering and evals IDE'
description: "Start prototyping and evaluating with Quotient AI's PromptLab"
icon: "thumbs-up"
---

Welcome to PromptLab, an advanced IDE for prototyping and evaluating prompts.

![PromptLab UI](../assets/prompt-lab/prompt-lab-landing-page.png)

 Here's how to start building with AI models:

## 📝 Get started

**PromptLab** is available within [Quotient's platform](https://app.quotientai.co/).
