---
title: "IQ - Your AI engineer copilot"
description: "Learn how to use Quotient IQ for real-time, feedback-aligned prompt optimization."
icon: "sparkles"
---

# Intelligent prompt optimization with IQ
...
- From the moment you provide feedback, the response is automatically recorded as "Bad" in the `Run Log` and any linked datasets.
---
...
For further assistance, feel free to reach out to our founders at [contact@quotientai.co](mailto:contact@quotientai.co) or check out more detailed documentation on [PromptLab](../promptlab/promptlab.mdx).
