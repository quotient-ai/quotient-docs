...
Every log captures a **single model interaction**, typically a user query, the model response, and the evidence used to produce that response. Detections, reports, and monitoring all build on top of these records.
