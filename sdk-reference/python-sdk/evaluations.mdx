...
Evaluations in Quotient track model performance through `Run` objects. Each Run combines a [prompt](/sdk-reference/python-sdk/prompts), [dataset](/sdk-reference/python-sdk/datasets), [model](/sdk-reference/python-sdk/models), and [metrics](/sdk-reference/python-sdk/metrics) to produce quantitative results.
...
<Note>Parameters vary by model. See [Models](/sdk-reference/python-sdk/models) for provider-specific options.</Note>
...
- [Datasets Documentation](/sdk-reference/python-sdk/datasets)
- [Metrics Documentation](/sdk-reference/python-sdk/metrics)
- [Models Documentation](/sdk-reference/python-sdk/models)
