...
Using the QuotientAI SDK, you can manage `Prompt`s by creating, retrieving, updating, and deleting them programmatically within your application.
...
Each prompt starts at version 0 upon creation. QuotientAI manages prompt versions, linking them by prompt name and unique ID. 
