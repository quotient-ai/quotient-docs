...
<Steps>
  <Step filename="Install the Quotient Python SDK">
    <CodeGroup>
  ...
  <Step filename="Create an API Key">
  ...
  <Step filename="Open in PromptLab">
