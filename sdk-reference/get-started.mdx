...
<Steps>
  ...
  <Step title="Create an API Key">
    ...
    <Tip>[Watch `API Key Creation` on YouTube](https://youtu.be/F5tMAsckl_c)</Tip>
  ...
  <Step title="Open in PromptLab">
    ...
    <Tip>[Watch `PromptLab Demo` on Youtube](https://youtu.be/LLjlatYsaM8)</Tip>
  </Step>
  <Step title="Iterate with IQ">
    ...
    <Tip>[Watch `Quotient IQ` on Youtube](https://youtu.be/X668xN83Z4A)</Tip>
