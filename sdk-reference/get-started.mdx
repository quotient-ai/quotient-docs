...
<Steps>
  ...
  <Step title="Create an API Key">
    ...
    [Watch the API Key Creation Video on YouTube](https://youtu.be/F5tMAsckl_c)
  ...
  <Step title="Create a Script">
    ...
    <CodeGroup>
      ...
      prompt = quotient.prompts.create(
        ...
        user_prompt="Your task is to assist customers by providing clear, concise, and helpful responses to their inquiries: {{input}}"
      )
  ...
  <Step title="Open in PromptLab">
    ...
    [Watch the demo video on Youtube](https://youtu.be/LLjlatYsaM8)
  </Step>
  <Step title="Iterate with IQ">
    ...
    [Watch the IQ video on Youtube](https://youtu.be/X668xN83Z4A)
